...
import { X, Cpu, Monitor, Activity, Settings, Wrench, Key } from 'lucide-react';
...
export const ServicesDirectoryModal = ({ isOpen, onClose, onBook }: ServicesDirectoryModalProps) => {
  return (
    <AnimatePresence>
      {isOpen && (
